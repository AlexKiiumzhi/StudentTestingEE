...
<div class="w3-row-padding w3-margin-top">
    ...
    <form action="${pageContext.request.contextPath}/app/user/searchBySubject" method="post">
    ...
    <form action="${pageContext.request.contextPath}/app/user/sortTests" method="post">
    ...
    <div class="w3-center w3-padding-32">
        <div class="w3-bar">
            <c:forEach begin="1" end="${numberOfPages}" varStatus="loop">
                <a href="${pageContext.request.contextPath}/app/user/tests?pageNumber=${loop.index}" class="w3-bar-item w3-button w3-theme">${loop.index}</a>
            </c:forEach>
        </div>
    </div>
