...
public class UserSearchTestBySubjectCommand implements Command {
    private TestService testService;
    private SubjectService subjectService;

    public UserSearchTestBySubjectCommand(TestService testService, SubjectService subjectService) {
